...
def bond_price0(maturity, principal=100, coupon_rate=0.03, coupons_per_year=12, discount_rate=0.03):
    """
    Old version bond_price
    """
    cash_flows = bond_cash_flows(maturity, principal, coupon_rate, coupons_per_year)
    return pv0(cash_flows, discount_rate/coupons_per_year)
...
def funding_ratio0(assets, liabilities, r):
    """
    Old version of funding_ratio
    """
    return assets/pv0(liabilities, r)


def funding_ratio02(assets, liabilities, r):
    """
    Old version of funding_ratio
    """
    return pv0(assets, r)/pv0(liabilities, r)
...
def macaulay_duration0(flows, discount_rate):
    """
    Old version of macaulay_duration
    """
    discounted_flows = discount0(flows.index, discount_rate)*flows
...
def match_durations0(cf_t, cf_s, cf_l, discount_rate):
    """
    Old version match_duration
    """
    d_t = macaulay_duration0(cf_t, discount_rate)
    d_s = macaulay_duration0(cf_s, discount_rate)
    d_l = macaulay_duration0(cf_l, discount_rate)
